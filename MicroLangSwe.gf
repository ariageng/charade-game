...
lin 
 ...
 -- e.g. (abstract) PredVPS   : NP -> VP -> S ;   
  ...
  PNVPS pn vp = {s = pn ++ vp.s } ;
  PNAPS pn ap = {s = pn ++ be_Verb.s ! PresSg3 ++ ap.s ! Utr ! Sg ! Indef } ;
  ...
  AdjPlIndefNP ap cn = {
    s = ap.s ! cn.g ! Pl ! Indef ++ cn.s ! Pl ! Indef;
    g = cn.g ;
    n = Pl 
    } ;
